                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-7 mb-1">
                            <div class="card shadow mb-3">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <?php
                                            $nim2 = $_SESSION['nim'];
                                            $data = mysqli_query($connect, "SELECT k.nim, m.nama_matkul, k.nilai from khs k INNER JOIN matkul m ON k.id_matkul = m.id_matkul Where k.nim =$nim2;");
                                            $awal = 0;
                                            $no = $awal + 1;
                                ...
                                <a class="btn btn-warning" href="cetak_invoice.php?id_peminjam=<?php echo $_SESSION['id_peminjam']; ?>">CETAK KHS</a>
                            </div>
                        </div>
                    </div>
                </div>
